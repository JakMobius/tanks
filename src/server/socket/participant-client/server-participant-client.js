...
const Logger = require("/src/server/log/logger")
const ClusterHandshake = require("../cluster-handshake")
const ServerParticipantConnection = require("./server-participant-connection")
...
module.exports = ServerParticipantClient