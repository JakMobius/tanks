...
const MapPacket = require("../../networking/packets/game-packets/mappacket.js")
const BinaryPacket = require("../../networking/binarypacket")
const PlayerJoinPacket = require("../../networking/packets/game-packets/playerjoinpacket")
const PlayerSpawnPacket = require("../../networking/packets/game-packets/playerspawnpacket")
const TankLocationsPacket = require("../../networking/packets/game-packets/gamestatepacket")
const PlayerControlsPacket = require("../../networking/packets/game-packets/playercontrolspacket")
const PlayerConfigPacket = require("../../networking/packets/game-packets/playerconfigpacket")
const PlayerRespawnPacket = require("../../networking/packets/game-packets/playerrespawnpacket")
const PlayerChatPacket = require("../../networking/packets/game-packets/playerchatpacket")
const EntityListPacket = require("../../networking/packets/game-packets/entitylistpacket")
const EntityCreatePacket = require("../../networking/packets/game-packets/entitycreatepacket")
const EntityRemovePacket = require("../../networking/packets/game-packets/entityremovepacket")
const BlockUpdatePacket = require("../../networking/packets/game-packets/blockupdatepacket")
const PlayerLeavePacket = require("../../networking/packets/game-packets/playerleavepacket")
const EffectCreatePacket = require("../../networking/packets/game-packets/effectcreatepacket")
const EffectRemovePacket = require("../../networking/packets/game-packets/effectremovepacket")
