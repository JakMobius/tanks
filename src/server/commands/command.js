...
const StringRepeat = require("../../utils/stringrepeat")
...
class Command {
	 ...
	 * @param {string} name Name or alias for subcommand to search
	 * @returns {Command|null} `null` if the flag was not found, {@link Command} otherwise
	 */
	getSubcommand(name) {
	 ...
	 * @param {string} name
	 * @returns {CommandFlag|null} `null` if the flag was not found, {@link CommandFlag} otherwise
	 */
	getFlag(name) {
	 ...
	 * @param args {string[]} Call arguments
	 * @returns {boolean} True if subcommand was called successfully, false otherwise
	 * @example
	 ...
	 * @param args {string[]}
	 * @returns {string[]} List of strings to autocomplete
	 */
