...
export default class PlayerListOverlay extends Overlay {
    ...
    constructor(options: OverlayConfig) {
        ...
        this.overlay.addClass("player-list-overlay")
        ...
        this.overlay.append(this.playerListMenu)
    }

    setGameWorld(world: Entity) {
        this.world = world

        this.world.on("player-statistics-updated", () => {
            this.updateTable()
        })

        this.world.on("map-name-updated", () => {
            this.updateMapName()
        })

        this.world.on("match-timer-set", () => {
            this.hookTimer()
        })
    ...
    getTimerText() {
        ...
        return timerComponent.getTimeString()
    }
