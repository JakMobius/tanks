...
const MapPacket = require("/src/networking/packets/game-packets/mappacket")
const PlayerJoinPacket = require("/src/networking/packets/game-packets/playerjoinpacket")
const PlayerSpawnPacket = require("/src/networking/packets/game-packets/playerspawnpacket")
const TankLocationsPacket = require("/src/networking/packets/game-packets/gamestatepacket")
const PlayerControlsPacket = require("/src/networking/packets/game-packets/playercontrolspacket")
const PlayerConfigPacket = require("/src/networking/packets/game-packets/playerconfigpacket")
const PlayerChatPacket = require("/src/networking/packets/game-packets/playerchatpacket")
const PlayerRespawnPacket = require("/src/networking/packets/game-packets/playerrespawnpacket")
const EntityCreatePacket = require("/src/networking/packets/game-packets/entitycreatepacket")
const EntityRemovePacket = require("/src/networking/packets/game-packets/entityremovepacket")
const EntityListPacket = require("/src/networking/packets/game-packets/entitylistpacket")
const BlockUpdatePacket = require("/src/networking/packets/game-packets/blockupdatepacket")
const PlayerLeavePacket = require("/src/networking/packets/game-packets/playerleavepacket")
const RoomListPacket = require("/src/networking/packets/game-packets/roomlistpacket")
const PlayerRoomRequestPacket = require("/src/networking/packets/game-packets/playerroomrequestpacket")
const PlayerRoomChangePacket = require("/src/networking/packets/game-packets/playerroomchangepacket")
const EffectCreatePacket = require("/src/networking/packets/game-packets/effectcreatepacket")
const EffectRemovePacket = require("/src/networking/packets/game-packets/effectremovepacket")
