...
interface TankInfoViewProps {
    world: Entity
}

const TankInfoView: React.FC<TankInfoViewProps> = (props) => {
    ...
    return (
        <div className="tank-info-overlay" style={{ display: state.shown ? undefined : "none" }}>
