...
import { Drawer } from "src/entity/types/tank-sniper/client-side/drawer";
...
const ClientPrefab = new EntityPrefab({
    ...
    metadata: {
        ...BasePrefab.metadata,
        description: "Классический танк. Взрыв от его снаряда может наносить урон " +
            "по нескольким соперникам одновременно."
    },
    prefab: (entity) => {
