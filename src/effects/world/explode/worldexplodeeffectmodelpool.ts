...
class WorldExplodeEffectModelPool {
	public powerDamping: any;
	public stepsPerSecond: any;
	public stepsWaiting: any;
	public walkers: any;
	public gridSize: any;
	public offsetMap: any;
	public roundOffsetMap: any;
	public waveCoefficient: any;
	public damageEnergyFraction: any;
	public forceCoefficient: any;
	public pressureDifferentialDistance: any;
    /**
     * @type GameWorld
     */
    world
    ...
    tickEntities(dt) {
        ...
        for(let player of this.world.players.values()) {
            ...
            tank.model.body.ApplyImpulse(new Box2D.b2Vec2(
                resultVx,
                resultVy
            ), position)
        }
...
export default WorldExplodeEffectModelPool;